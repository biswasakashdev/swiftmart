...
import static com.biswasakashdev.swiftmart.protogen.core.v1.UsersServiceGrpc.getServiceDescriptor;
...
comments = "Source: core/v1/Users.proto")
public final class ReactorUsersServiceGrpc {
    ...
    public static final class ReactorUsersServiceStub extends io.grpc.stub.AbstractStub<ReactorUsersServiceStub> {
        ...
        public reactor.core.publisher.Mono<com.biswasakashdev.swiftmart.protogen.core.v1.CreateAccountResponse> createAccount(reactor.core.publisher.Mono<com.biswasakashdev.swiftmart.protogen.core.v1.CreateAccountRequest> reactorRequest) {
            return com.salesforce.reactorgrpc.stub.ClientCalls.oneToOne(reactorRequest, delegateStub::createAccount, getCallOptions());
        }

        public reactor.core.publisher.Mono<com.biswasakashdev.swiftmart.protogen.core.v1.AuthorizeResponse> authorize(reactor.core.publisher.Mono<com.biswasakashdev.swiftmart.protogen.core.v1.AuthorizeRequest> reactorRequest) {
            return com.salesforce.reactorgrpc.stub.ClientCalls.oneToOne(reactorRequest, delegateStub::authorize, getCallOptions());
        }

        public reactor.core.publisher.Mono<com.biswasakashdev.swiftmart.protogen.core.v1.CreateAccountResponse> createAccount(com.biswasakashdev.swiftmart.protogen.core.v1.CreateAccountRequest reactorRequest) {
        ...
        public reactor.core.publisher.Mono<com.biswasakashdev.swiftmart.protogen.core.v1.AuthorizeResponse> authorize(com.biswasakashdev.swiftmart.protogen.core.v1.AuthorizeRequest reactorRequest) {
    ...
    public static abstract class UsersServiceImplBase implements io.grpc.BindableService {
        ...
        public reactor.core.publisher.Mono<com.biswasakashdev.swiftmart.protogen.core.v1.CreateAccountResponse> createAccount(com.biswasakashdev.swiftmart.protogen.core.v1.CreateAccountRequest request) {
            return createAccount(reactor.core.publisher.Mono.just(request));
        }

        public reactor.core.publisher.Mono<com.biswasakashdev.swiftmart.protogen.core.v1.CreateAccountResponse> createAccount(reactor.core.publisher.Mono<com.biswasakashdev.swiftmart.protogen.core.v1.CreateAccountRequest> request) {
            throw new io.grpc.StatusRuntimeException(io.grpc.Status.UNIMPLEMENTED);
        }

        public reactor.core.publisher.Mono<com.biswasakashdev.swiftmart.protogen.core.v1.AuthorizeResponse> authorize(com.biswasakashdev.swiftmart.protogen.core.v1.AuthorizeRequest request) {
            return authorize(reactor.core.publisher.Mono.just(request));
        }

        public reactor.core.publisher.Mono<com.biswasakashdev.swiftmart.protogen.core.v1.AuthorizeResponse> authorize(reactor.core.publisher.Mono<com.biswasakashdev.swiftmart.protogen.core.v1.AuthorizeRequest> request) {
            throw new io.grpc.StatusRuntimeException(io.grpc.Status.UNIMPLEMENTED);
        }
        ...
        @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            com.biswasakashdev.swiftmart.protogen.core.v1.UsersServiceGrpc.getCreateAccountMethod(),
                            asyncUnaryCall(
                                    new MethodHandlers<
                    ...
                    .addMethod(
                            com.biswasakashdev.swiftmart.protogen.core.v1.UsersServiceGrpc.getAuthorizeMethod(),
                            asyncUnaryCall(
                                    new MethodHandlers<
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_CREATE_ACCOUNT:
                    com.salesforce.reactorgrpc.stub.ServerCalls.oneToOne((com.biswasakashdev.swiftmart.protogen.core.v1.CreateAccountRequest) request,
                ...
                case METHODID_AUTHORIZE:
                    com.salesforce.reactorgrpc.stub.ServerCalls.oneToOne((com.biswasakashdev.swiftmart.protogen.core.v1.AuthorizeRequest) request,

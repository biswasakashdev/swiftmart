...
public final class UsersServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "users.v1.UsersService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountRequest,
      com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountResponse> getCreateAccountMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateAccount",
      requestType = com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountRequest.class,
      responseType = com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountRequest,
      com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountResponse> getCreateAccountMethod() {
    io.grpc.MethodDescriptor<com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountRequest, com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountResponse> getCreateAccountMethod;
      ...
      synchronized (UsersServiceGrpc.class) {
        if ((getCreateAccountMethod = UsersServiceGrpc.getCreateAccountMethod) == null) {
          UsersServiceGrpc.getCreateAccountMethod = getCreateAccountMethod =
              io.grpc.MethodDescriptor.<com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountRequest, com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateAccount"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeRequest,
      com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeResponse> getAuthorizeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Authorize",
      requestType = com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeRequest.class,
      responseType = com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeRequest,
      com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeResponse> getAuthorizeMethod() {
    io.grpc.MethodDescriptor<com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeRequest, com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeResponse> getAuthorizeMethod;
    if ((getAuthorizeMethod = UsersServiceGrpc.getAuthorizeMethod) == null) {
      synchronized (UsersServiceGrpc.class) {
        if ((getAuthorizeMethod = UsersServiceGrpc.getAuthorizeMethod) == null) {
          UsersServiceGrpc.getAuthorizeMethod = getAuthorizeMethod =
              io.grpc.MethodDescriptor.<com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeRequest, com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Authorize"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createAccount(com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountRequest request,
    ...
    /**
     */
    default void authorize(com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeRequest request,
  ...
  public static final class UsersServiceStub
    ...
    /**
     */
    public void createAccount(com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountRequest request,
        io.grpc.stub.StreamObserver<com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountResponse> responseObserver) {
    ...
    /**
     */
    public void authorize(com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeRequest request,
        io.grpc.stub.StreamObserver<com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class UsersServiceBlockingV2Stub
    ...
    /**
     */
    public com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountResponse createAccount(com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountRequest request) throws io.grpc.StatusException {
    ...
    /**
     */
    public com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeResponse authorize(com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
  ...
  public static final class UsersServiceBlockingStub
    ...
    /**
     */
    public com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountResponse createAccount(com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountRequest request) {
    ...
    /**
     */
    public com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeResponse authorize(com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getAuthorizeMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class UsersServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountResponse> createAccount(
        com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeResponse> authorize(
        com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_ACCOUNT:
          serviceImpl.createAccount((com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountRequest) request,
              (io.grpc.stub.StreamObserver<com.biswasakashdev.swiftmart.protogen.users.v1.CreateAccountResponse>) responseObserver);
          break;
        case METHODID_AUTHORIZE:
          serviceImpl.authorize((com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeRequest) request,
              (io.grpc.stub.StreamObserver<com.biswasakashdev.swiftmart.protogen.users.v1.AuthorizeResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class UsersServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.biswasakashdev.swiftmart.protogen.users.v1.MainProto.getDescriptor();
    }
